...
import { Heart, Home, Search, Building2, UserPlus } from "lucide-react"
...
export function Navigation() {
  ...
  const navItems = [
    ...
    { href: "/adopter-dashboard", label: "Adopters", icon: Heart },
    { href: "/shelter-dashboard", label: "Shelters", icon: Building2 },
